...
- [ ] 评估并实现下一个 P1：更完整的联系人/会话体验或打包发布细节。
- [ ] 明确暂缓 P2：永久群聊、多文件/文件夹、断点续传、撤回、已读、加密。
- **状态：** 进行中；聊天记录搜索、系统托盘、桌面通知和未读提醒强化已完成。
...
2. 推进阶段 15 的 P1 功能，优先实现聊天记录搜索。
3. 后续再评估桌面通知、系统托盘和更完整的联系人/会话体验。
4. P2 功能继续保持延期：永久群聊、多文件/文件夹、断点续传、撤回、已读、加密。
